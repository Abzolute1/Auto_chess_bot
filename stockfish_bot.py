...
class GUI:
    def __init__(self, master):
        ...
        master.title("Chess")
        master.geometry("")
        master.iconphoto(True,
                         tk.PhotoImage(file="C:/Users/Alex/Desktop/chess-auto-bot-main/src/assets/pawn_32x32.png"))
        ...
        self.non_stop_matches_check_button = tk.Checkbutton(left_frame, text="Non-stop online Unrated",
        ...
        while not self.exit:
            try:
                if (
                    ...
                    elif data.startswith("ERR_GENERAL_"):
                        error_msg = data[12:]  # Remove "ERR_GENERAL_" prefix
                        messagebox.showerror(
                            "Error",
                ...
                # Don't set pipe to None immediately, just continue
                # The pipe will be properly closed when stopping
                pass
            except Exception as e:
                print(f"Unexpected error in process_communicator_thread: {e}")
                pass
    ...
    def on_open_browser_button_listener(self):
        ...
        try:
            ...
            # Use these compatible options instead
            ...
            print(f"Chrome URL: {self.chrome_url}")
            print(f"Chrome Session ID: {self.chrome_session_id}")

            # Update UI
            self.open_browser_button["text"] = "Browser Opened"
    ...
    def on_start_button_listener(self):
        ...
        # FIXED: Use multiprocessing.Pipe instead of multiprocess.Pipe
        ...
        self.stockfish_bot_process = StockfishBot(
            ...
            True,  # enable_human_delays
            2.0,  # min_thinking_time
            12.0,  # max_thinking_time
        )
    ...
    def on_stop_button_listener(self):
        ...
        if self.overlay_screen_process is not None:
            try:
                ...
                self.overlay_screen_process.join(timeout=2)
